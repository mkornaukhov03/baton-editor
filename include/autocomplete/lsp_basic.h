...
struct Diagnostic {
    ...
    std::string source;
    std::string message;
    std::optional<std::vector<DiagnosticRelatedInformation>> relatedInformation = std::vector<DiagnosticRelatedInformation> {};

    std::optional<std::string> category = std::string{};

    // clagd extension
    std::optional<std::vector<CodeAction>> codeActions = std::vector<CodeAction> {};
};
...
struct WorkspaceEdit {
    std::optional<std::map<std::string, std::vector<TextEdit>>> changes = std::map<std::string, std::vector<TextEdit>>();
};
struct TweakArgs {
    std::string file;
    Range selection;
...
struct CodeAction {
    ...
    std::optional<std::vector<Diagnostic>> diagnostics = std::vector<Diagnostic> {};
...
struct ParameterInformation {
    ...
    std::optional<std::pair<unsigned, unsigned>> labelOffsets = std::pair<unsigned, unsigned> {}; // clangd specific
    std::string documentation;
};
...
struct TypeHierarchyItem {
    ...
    std::optional<std::vector<TypeHierarchyItem>> parents = std::vector<TypeHierarchyItem> {};

    std::optional<std::vector<TypeHierarchyItem>> children = std::vector<TypeHierarchyItem> {};
};
struct FileStatus {
    DocumentUri uri;
    TextType state;
